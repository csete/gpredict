...
GtkWidget      *sat_pref_sky_at_glance_create()
{
    ...
    gtk_table_attach(GTK_TABLE(table),
                     gtk_hseparator_new(),
                     0, 5, 2, 3, GTK_FILL | GTK_EXPAND, GTK_SHRINK, 0, 0);
    ...
    gtk_misc_set_alignment(GTK_MISC(label), 0.0, 0.5);
    gtk_table_attach(GTK_TABLE(table), label,
                     0, 1, y, y + 1, GTK_FILL, GTK_SHRINK, 0, 0);

    /* colour 1 */
    label = gtk_label_new(_("Colour for satellite 1: "));
    gtk_misc_set_alignment(GTK_MISC(label), 1.0, 0.5);
    gtk_table_attach(GTK_TABLE(table), label,
                     0, 1, y + 1, y + 2, GTK_SHRINK, GTK_SHRINK, 0, 0);
    ...
    gtk_table_attach(GTK_TABLE(table), col1,
                     1, 2, y + 1, y + 2, GTK_FILL, GTK_FILL, 0, 0);
    ...
    gtk_misc_set_alignment(GTK_MISC(label), 1.0, 0.5);
    gtk_table_attach(GTK_TABLE(table), label,
                     0, 1, y + 2, y + 3, GTK_SHRINK, GTK_SHRINK, 0, 0);
    ...
    gtk_table_attach(GTK_TABLE(table), col2,
                     1, 2, y + 2, y + 3, GTK_FILL, GTK_FILL, 0, 0);
    ...
    gtk_misc_set_alignment(GTK_MISC(label), 1.0, 0.5);
    gtk_table_attach(GTK_TABLE(table), label,
                     0, 1, y + 3, y + 4, GTK_SHRINK, GTK_SHRINK, 0, 0);
    ...
    gtk_table_attach(GTK_TABLE(table), col3,
                     1, 2, y + 3, y + 4, GTK_FILL, GTK_FILL, 0, 0);
    ...
    gtk_misc_set_alignment(GTK_MISC(label), 1.0, 0.5);
    gtk_table_attach(GTK_TABLE(table), label,
                     0, 1, y + 4, y + 5, GTK_SHRINK, GTK_SHRINK, 0, 0);
    ...
    gtk_table_attach(GTK_TABLE(table), col4,
                     1, 2, y + 4, y + 5, GTK_FILL, GTK_FILL, 0, 0);
    ...
    gtk_misc_set_alignment(GTK_MISC(label), 1.0, 0.5);
    gtk_table_attach(GTK_TABLE(table), label,
                     0, 1, y + 5, y + 6, GTK_SHRINK, GTK_SHRINK, 0, 0);
    ...
    gtk_table_attach(GTK_TABLE(table), col5,
                     1, 2, y + 5, y + 6, GTK_FILL, GTK_FILL, 0, 0);
    ...
    gtk_misc_set_alignment(GTK_MISC(label), 1.0, 0.5);
    gtk_table_attach(GTK_TABLE(table), label,
                     3, 4, y + 1, y + 2, GTK_SHRINK, GTK_SHRINK, 0, 0);
    ...
    gtk_table_attach(GTK_TABLE(table), col6,
                     4, 5, y + 1, y + 2, GTK_FILL, GTK_FILL, 0, 0);
    ...
    gtk_misc_set_alignment(GTK_MISC(label), 1.0, 0.5);
    gtk_table_attach(GTK_TABLE(table), label,
                     3, 4, y + 2, y + 3, GTK_SHRINK, GTK_SHRINK, 0, 0);
    ...
    gtk_table_attach(GTK_TABLE(table), col7,
                     4, 5, y + 2, y + 3, GTK_FILL, GTK_FILL, 0, 0);
    ...
    gtk_misc_set_alignment(GTK_MISC(label), 1.0, 0.5);
    gtk_table_attach(GTK_TABLE(table), label,
                     3, 4, y + 3, y + 4, GTK_SHRINK, GTK_SHRINK, 0, 0);
    ...
    gtk_table_attach(GTK_TABLE(table), col8,
                     4, 5, y + 3, y + 4, GTK_FILL, GTK_FILL, 0, 0);
    ...
    gtk_misc_set_alignment(GTK_MISC(label), 1.0, 0.5);
    gtk_table_attach(GTK_TABLE(table), label,
                     3, 4, y + 4, y + 5, GTK_SHRINK, GTK_SHRINK, 0, 0);
    ...
    gtk_table_attach(GTK_TABLE(table), col9,
                     4, 5, y + 4, y + 5, GTK_FILL, GTK_FILL, 0, 0);
    ...
    gtk_misc_set_alignment(GTK_MISC(label), 1.0, 0.5);
    gtk_table_attach(GTK_TABLE(table), label,
                     3, 4, y + 5, y + 6, GTK_SHRINK, GTK_SHRINK, 0, 0);
    ...
    gtk_table_attach(GTK_TABLE(table), col10,
                     4, 5, y + 5, y + 6, GTK_FILL, GTK_FILL, 0, 0);
