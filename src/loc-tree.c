...
*/
/** \brief Tree widget containing locations info
 */
#include <glib.h>
#include <gtk/gtk.h>
...
/** \brief Render column containing integer.
 */
static void
loc_tree_int_cell_data_function (GtkTreeViewColumn *col,
                                         GtkCellRenderer   *renderer,
                                         GtkTreeModel      *model,
                                         GtkTreeIter       *iter,
                                         gpointer           column)
...
/** \brief get data fom selected row. */
static void
loc_tree_get_selection            (GtkWidget *view,
                                           gchar     **loc,
                                           gfloat     *lat,
                                           gfloat     *lon,
                                           guint      *alt,
