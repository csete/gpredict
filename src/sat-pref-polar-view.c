 ...
 */
static void
create_orient_selector  (GKeyFile *cfg, GtkBox *vbox)
{
	GtkWidget *label;
	GtkWidget *hbox;
	GtkTooltips *tips;
 ...
 */
static void
orient_chganged (GtkToggleButton *but, gpointer data)
{
 ...
 */
void
sat_pref_polar_view_cancel (GKeyFile *cfg)
{
	dirty = FALSE;
}
 ...
 */
void
sat_pref_polar_view_ok     (GKeyFile *cfg)
{
	guint    rgba;
	guint16  alpha;
	GdkColor col;
